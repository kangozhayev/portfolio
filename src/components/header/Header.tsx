...
/* надёжный scroll-spy: активная — чья верхняя граница прошла под шапкой */
...
export default function Header() {
  ...
  return (
    <nav className="fixed top-3 inset-x-0 z-[9999]">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        {/* Капсула: 3 колонки — слева меню, центр бренд, справа экшены */}
        <div
          className={`
            grid grid-cols-[1fr_auto_1fr] items-center
    rounded-[999px]
    ${scrolled ? 'bg-zinc-950/90' : 'bg-zinc-950/80'}   // ФОН
    ring-1 ring-black/70                                 // КРАЙ
  ...
  "
    ...
    "
              />
              {/* sheen-блик, проезжающий по кнопке на hover */}
